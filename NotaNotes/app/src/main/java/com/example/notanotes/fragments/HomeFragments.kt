...
import com.example.notanotes.adapter.NoteAdapter
import com.example.notanotes.databinding.FragmentHomeBinding
import com.example.notanotes.model.Note
import com.example.notanotes.viewmodel.NoteViewModel


class HomeFragments : Fragment(R.layout.fragment_home) , SearchView.OnQueryTextListener, MenuProvider {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.addNoteFab.setOnClickListener{
            it.findNavController().navigate(R.id.action_homeFragments_to_addNotesFragments)
        }
